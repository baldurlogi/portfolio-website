...
import { BsLinkedin, BsRocket } from 'react-icons/bs';
    ...
    >
      <div className="flex items-center justify-center">
        <div className="relative">
          ...
          >
            <Image
              src="/profile_picture_portfolio.png"
              alt="Baldur portrait"
              width="192"
              height="192"
              quality="95"
      ...
      >
        ...
        <span className="font-bold">Software Engineer</span>. I am currently
        open for a full-time{' '}
        <span className="underline">frontend or full-stack developer</span> job.
      </motion.h1>
      ...
      >
        <a
          ...
          href="/Baldur_SoftwareEngineer_CV_2026.pdf"
          download
        >
          Download CV{' '}
        ...
        <a
          className="group bg-white px-7 py-3 flex items-center gap-2 rounded-full outline-none focus:scale-110 hover:scale-110 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10"
          href="https://begyn.app"
          target="_blank"
          aria-label="Visit Begyn - AI-powered life system"
        >
          Begyn App{' '}
          <BsRocket className="opacity-60 group-hover:translate-x-1 transition" />
        </a>
